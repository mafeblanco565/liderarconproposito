      ...
      <section id="saber-hacer" className="chapter chapter--hacer" aria-labelledby="hacer-title">
        ...
        <div className="impact-grid">
          ...
          <article className="impact-card impact-card--challenge">
            ...
            <div className="impact-card__footer">El impacto: recuperación de cuota de mercado y un nuevo impulso comercial bajo la metodología <b className="metodologia">«Behinder»</b>: dar valor a vendedores y líderes para que alcancen sus objetivos personales y profesionales, y que eso se traduzca en resultados; en este caso, ventas.</div>
          </article>
        </div>
